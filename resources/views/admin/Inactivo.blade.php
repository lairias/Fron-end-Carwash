...
<section class="wrapper">
    ...
    <div class="container">
        ...
        <div id="scene" class="scene" data-hover-only="false">
            ...
            <p class="p404" data-depth="0.50">Ups!</p>
            <p class="p404" data-depth="0.10">Error de cuenta</p>

        </div>

        <div class="text">
            <article>
                <p>Su cuenta se encuentra <br>Suspendida o Inactiva dentro del sistema</p>
                <button> <a href=" {{ route('logout') }}" onclick="event.preventDefault();
